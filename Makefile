...
PYTHON_TESTS := runtime_package agent_queue_hardening artifact_safety webapp_control procedure_hints recoveryctl_live recovery_capability recovery_demo_fixture recovery_pipeline recovery_api lock_recovery lockctl extjob_provenance extjobctl company_auth company_auth_api company_auth_http fleet fleet_metadata fleet_api execution_console evidence_reports testmode_standalone
...
test-frontend:
	node --test tests/frontend.mjs tests/release_ux.mjs tests/fleet_metadata.mjs
